...
:- modeb(*,projectsU(+user,#projectsUSetType))?
:- modeb(*,expertiseU(+user,#expertiseUSetType))?
:- modeb(*,adminRolesU(+user,#adminRolesUSetType))?
:- modeb(1,departmentU(+user,#departmentUType))?
:- modeb(*,tasksU(+user,#tasksUSetType))?
:- modeb(*,projectsLedU(+user,#projectsLedUSetType))?
:- modeb(1,isEmployeeU(+user,#isEmployeeUType))?
:- modeb(1,projectR(+resource,#projectRType))?
:- modeb(1,expertiseR(+resource,#expertiseRSetType))?
