...
:- modeb(1,uidU(+user,#attribValAtomic))?
:- modeb(1,memberTypeU(+user,-attribValAtomic))?
:- modeb(1,memberTypeU(+user,#attribValAtomic))?
:- modeb(1,ageGroupU(+user,-attribValAtomic))?
:- modeb(1,ageGroupU(+user,#attribValAtomic))?
:- modeb(1,ridR(+resource,-attribValAtomic))?
:- modeb(1,ridR(+resource,#attribValAtomic))?
:- modeb(1,ratingR(+resource,-attribValAtomic))?
:- modeb(1,ratingR(+resource,#attribValAtomic))?
:- modeb(1,videoTypeR(+resource,-attribValAtomic))?
:- modeb(1,videoTypeR(+resource,#attribValAtomic))?
