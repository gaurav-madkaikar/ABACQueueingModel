...
:- modeb(1,positionU(+user,-attribValAtomic))?
:- modeb(1,positionU(+user,#attribValAtomic))?
:- modeb(1,uidU(+user,-attribValAtomic))?
:- modeb(1,uidU(+user,#attribValAtomic))?
:- modeb(*,teamsU(+user,-attribValAtomic))?
:- modeb(*,teamsU(+user,#attribValAtomic))?
:- modeb(*,specialtiesU(+user,-attribValAtomic))?
:- modeb(*,specialtiesU(+user,#attribValAtomic))?
:- modeb(1,wardU(+user,-attribValAtomic))?
:- modeb(1,wardU(+user,#attribValAtomic))?
:- modeb(*,agentForU(+user,-attribValAtomic))?
:- modeb(*,agentForU(+user,#attribValAtomic))?
:- modeb(1,treatingTeamR(+resource,-attribValAtomic))?
:- modeb(1,treatingTeamR(+resource,#attribValAtomic))?
:- modeb(1,authorR(+resource,-attribValAtomic))?
:- modeb(1,authorR(+resource,#attribValAtomic))?
:- modeb(*,topicsR(+resource,-attribValAtomic))?
:- modeb(1,topicsR(+resource,#attribValAtomic))?
:- modeb(1,patientR(+resource,-attribValAtomic))?
:- modeb(1,patientR(+resource,#attribValAtomic))?
:- modeb(1,wardR(+resource,-attribValAtomic))?
:- modeb(1,wardR(+resource,#attribValAtomic))?
...
teamsU_superset_topicsR(U,R) :- setof(X,teamsU(U,X),SU), setof(Y,topicsR(R,Y),SR), superset(SU,SR).
specialtiesU_superset_topicsR(U,R) :- setof(X,specialtiesU(U,X),SU), setof(Y,topicsR(R,Y),SR), superset(SU,SR).
agentForU_superset_topicsR(U,R) :- setof(X,agentForU(U,X),SU), setof(Y,topicsR(R,Y),SR), superset(SU,SR).
teamsU_contains_treatingTeamR(U,R) :- setof(X,teamsU(U,X),SU),treatingTeamR(R,Y), element(Y,SU).
teamsU_contains_authorR(U,R) :- setof(X,teamsU(U,X),SU),authorR(R,Y), element(Y,SU).
teamsU_contains_patientR(U,R) :- setof(X,teamsU(U,X),SU),patientR(R,Y), element(Y,SU).
teamsU_contains_wardR(U,R) :- setof(X,teamsU(U,X),SU),wardR(R,Y), element(Y,SU).
teamsU_contains_ridR(U,R) :- setof(X,teamsU(U,X),SU),ridR(R,Y), element(Y,SU).
teamsU_contains_typeR(U,R) :- setof(X,teamsU(U,X),SU),typeR(R,Y), element(Y,SU).
specialtiesU_contains_treatingTeamR(U,R) :- setof(X,specialtiesU(U,X),SU),treatingTeamR(R,Y), element(Y,SU).
specialtiesU_contains_authorR(U,R) :- setof(X,specialtiesU(U,X),SU),authorR(R,Y), element(Y,SU).
specialtiesU_contains_patientR(U,R) :- setof(X,specialtiesU(U,X),SU),patientR(R,Y), element(Y,SU).
specialtiesU_contains_wardR(U,R) :- setof(X,specialtiesU(U,X),SU),wardR(R,Y), element(Y,SU).
specialtiesU_contains_ridR(U,R) :- setof(X,specialtiesU(U,X),SU),ridR(R,Y), element(Y,SU).
specialtiesU_contains_typeR(U,R) :- setof(X,specialtiesU(U,X),SU),typeR(R,Y), element(Y,SU).
agentForU_contains_treatingTeamR(U,R) :- setof(X,agentForU(U,X),SU),treatingTeamR(R,Y), element(Y,SU).
agentForU_contains_authorR(U,R) :- setof(X,agentForU(U,X),SU),authorR(R,Y), element(Y,SU).
agentForU_contains_patientR(U,R) :- setof(X,agentForU(U,X),SU),patientR(R,Y), element(Y,SU).
agentForU_contains_wardR(U,R) :- setof(X,agentForU(U,X),SU),wardR(R,Y), element(Y,SU).
agentForU_contains_ridR(U,R) :- setof(X,agentForU(U,X),SU),ridR(R,Y), element(Y,SU).
agentForU_contains_typeR(U,R) :- setof(X,agentForU(U,X),SU),typeR(R,Y), element(Y,SU).
