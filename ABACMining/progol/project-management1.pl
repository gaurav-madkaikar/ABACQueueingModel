...
:- modeb(1,uidU(+user,-attribValAtomic))?
:- modeb(1,uidU(+user,#attribValAtomic))?
:- modeb(*,projectsU(+user,-attribValAtomic))?
:- modeb(*,projectsU(+user,#attribValAtomic))?
:- modeb(*,expertiseU(+user,-attribValAtomic))?
:- modeb(*,expertiseU(+user,#attribValAtomic))?
:- modeb(*,adminRolesU(+user,-attribValAtomic))?
:- modeb(*,adminRolesU(+user,#attribValAtomic))?
:- modeb(1,departmentU(+user,-attribValAtomic))?
:- modeb(1,departmentU(+user,#attribValAtomic))?
:- modeb(*,tasksU(+user,-attribValAtomic))?
:- modeb(*,tasksU(+user,#attribValAtomic))?
:- modeb(*,projectsLedU(+user,-attribValAtomic))?
:- modeb(*,projectsLedU(+user,#attribValAtomic))?
:- modeb(1,isEmployeeU(+user,-attribValAtomic))?
:- modeb(1,isEmployeeU(+user,#attribValAtomic))?
:- modeb(1,projectR(+resource,-attribValAtomic))?
:- modeb(1,projectR(+resource,#attribValAtomic))?
:- modeb(*,expertiseR(+resource,-attribValAtomic))?
:- modeb(1,expertiseR(+resource,#attribValAtomic))?
:- modeb(1,ridR(+resource,-attribValAtomic))?
:- modeb(1,ridR(+resource,#attribValAtomic))?
:- modeb(1,departmentR(+resource,-attribValAtomic))?
:- modeb(1,departmentR(+resource,#attribValAtomic))?
:- modeb(1,proprietaryR(+resource,-attribValAtomic))?
:- modeb(1,proprietaryR(+resource,#attribValAtomic))?
:- modeb(1,typeR(+resource,-attribValAtomic))?
:- modeb(1,typeR(+resource,#attribValAtomic))?
...
projectsU_superset_expertiseR(U,R) :- setof(X,projectsU(U,X),SU), setof(Y,expertiseR(R,Y),SR), superset(SU,SR).
expertiseU_superset_expertiseR(U,R) :- setof(X,expertiseU(U,X),SU), setof(Y,expertiseR(R,Y),SR), superset(SU,SR).
adminRolesU_superset_expertiseR(U,R) :- setof(X,adminRolesU(U,X),SU), setof(Y,expertiseR(R,Y),SR), superset(SU,SR).
tasksU_superset_expertiseR(U,R) :- setof(X,tasksU(U,X),SU), setof(Y,expertiseR(R,Y),SR), superset(SU,SR).
projectsLedU_superset_expertiseR(U,R) :- setof(X,projectsLedU(U,X),SU), setof(Y,expertiseR(R,Y),SR), superset(SU,SR).
projectsU_contains_projectR(U,R) :- setof(X,projectsU(U,X),SU),projectR(R,Y), element(Y,SU).
projectsU_contains_ridR(U,R) :- setof(X,projectsU(U,X),SU),ridR(R,Y), element(Y,SU).
projectsU_contains_departmentR(U,R) :- setof(X,projectsU(U,X),SU),departmentR(R,Y), element(Y,SU).
projectsU_contains_proprietaryR(U,R) :- setof(X,projectsU(U,X),SU),proprietaryR(R,Y), element(Y,SU).
projectsU_contains_typeR(U,R) :- setof(X,projectsU(U,X),SU),typeR(R,Y), element(Y,SU).
expertiseU_contains_projectR(U,R) :- setof(X,expertiseU(U,X),SU),projectR(R,Y), element(Y,SU).
expertiseU_contains_ridR(U,R) :- setof(X,expertiseU(U,X),SU),ridR(R,Y), element(Y,SU).
expertiseU_contains_departmentR(U,R) :- setof(X,expertiseU(U,X),SU),departmentR(R,Y), element(Y,SU).
expertiseU_contains_proprietaryR(U,R) :- setof(X,expertiseU(U,X),SU),proprietaryR(R,Y), element(Y,SU).
expertiseU_contains_typeR(U,R) :- setof(X,expertiseU(U,X),SU),typeR(R,Y), element(Y,SU).
adminRolesU_contains_projectR(U,R) :- setof(X,adminRolesU(U,X),SU),projectR(R,Y), element(Y,SU).
adminRolesU_contains_ridR(U,R) :- setof(X,adminRolesU(U,X),SU),ridR(R,Y), element(Y,SU).
adminRolesU_contains_departmentR(U,R) :- setof(X,adminRolesU(U,X),SU),departmentR(R,Y), element(Y,SU).
adminRolesU_contains_proprietaryR(U,R) :- setof(X,adminRolesU(U,X),SU),proprietaryR(R,Y), element(Y,SU).
adminRolesU_contains_typeR(U,R) :- setof(X,adminRolesU(U,X),SU),typeR(R,Y), element(Y,SU).
tasksU_contains_projectR(U,R) :- setof(X,tasksU(U,X),SU),projectR(R,Y), element(Y,SU).
tasksU_contains_ridR(U,R) :- setof(X,tasksU(U,X),SU),ridR(R,Y), element(Y,SU).
tasksU_contains_departmentR(U,R) :- setof(X,tasksU(U,X),SU),departmentR(R,Y), element(Y,SU).
tasksU_contains_proprietaryR(U,R) :- setof(X,tasksU(U,X),SU),proprietaryR(R,Y), element(Y,SU).
tasksU_contains_typeR(U,R) :- setof(X,tasksU(U,X),SU),typeR(R,Y), element(Y,SU).
projectsLedU_contains_projectR(U,R) :- setof(X,projectsLedU(U,X),SU),projectR(R,Y), element(Y,SU).
projectsLedU_contains_ridR(U,R) :- setof(X,projectsLedU(U,X),SU),ridR(R,Y), element(Y,SU).
projectsLedU_contains_departmentR(U,R) :- setof(X,projectsLedU(U,X),SU),departmentR(R,Y), element(Y,SU).
projectsLedU_contains_proprietaryR(U,R) :- setof(X,projectsLedU(U,X),SU),proprietaryR(R,Y), element(Y,SU).
projectsLedU_contains_typeR(U,R) :- setof(X,projectsLedU(U,X),SU),typeR(R,Y), element(Y,SU).
